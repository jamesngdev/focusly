...
import {FOCUS_TIME_SETTING_KEY, QUIZLET_SETS_ID_SETTING_KEY, RELAX_TIME_SETTING_KEY} from "@/consts/setting.ts";
...
function SettingForm() {
    const form = useForm<z.infer<typeof FormSchema>>({
        ...
        defaultValues: {
            [QUIZLET_SETS_ID_SETTING_KEY]: localStorage.getItem(QUIZLET_SETS_ID_SETTING_KEY) ?? '',
            [FOCUS_TIME_SETTING_KEY]: localStorage.getItem(FOCUS_TIME_SETTING_KEY) ?? '',
            [RELAX_TIME_SETTING_KEY]: localStorage.getItem(RELAX_TIME_SETTING_KEY) ?? '',
        },
    })
